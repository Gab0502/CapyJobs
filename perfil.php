...
<body class="coloracao-body">
    ...
    <main class="bullet-points APOLLO">
        ...
        <section class="margin-pub">
            <aside class="tam-asideD">
                <img src="images/capivaraTernoIcon.jpg" alt="">
            </aside>
            <div>
                <div class="pub-perfil">
                <img src="images/capivaraPadraoIcon.jpg" alt="">
                </div>
                ...
                <h5>
                    essa foi uma festa infantil que participamos <br> 
                    junto com nosso colaborador <a href="">@alguem-legal</a> <Br>
                    e nosso amigo do coraçaõ  <a href="">dr.Hannibal</a> 
                </h5>
                <div>
                    curtir compartilhar 
                </div>
